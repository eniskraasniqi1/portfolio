  ...
  return (
    <div className="flex animate-fade-in flex-wrap items-center gap-3 sm:gap-4 animation-delay-3 mt-4">
      {profileLinks.map((link, idx) => (
        <a
          key={idx}
          className={`${link.className} px-3 py-2 rounded-lg transition-all duration-200 hover:bg-zinc-50 hover:shadow-sm flex items-center gap-2 dark:hover:bg-zinc-800/60`}
          href={link.href}
